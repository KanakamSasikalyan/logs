# logs
 ...
 Cloning from https://github.com/KanakamSasikalyan/react-frontend
==> Checking out commit ee0ab1a2b651b24e0ff119d46e8f5a07a62f1586 in branch feature/test-tryon-redirection
==> Downloading cache...
==> Transferred 259MB in 7s. Extraction took 6s.
...
added 1 package, changed 2 packages, and audited 1316 packages in 4s
...
up to date, audited 1316 packages in 1s
269 packages are looking for funding
  run `npm fund` for details
12 vulnerabilities (2 low, 2 moderate, 8 high)
To address all issues (including breaking changes), run:
...
warning react-scripts > babel-preset-react-app > @babel/plugin-proposal-private-property-in-object@7.21.11: This proposal has been merged to the ECMAScript standard and thus this plugin is no longer maintained. Please use @babel/plugin-transform-private-property-in-object instead.
